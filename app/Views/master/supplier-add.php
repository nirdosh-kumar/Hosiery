           ...
           <div class="row">
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1">
				  <ul>
					<li><a href="<?php echo base_url(); ?>master/add-supplier" class="activelink">Add <img src="<?php echo base_url(); ?>public/assets/img/icons/add-icon.png" class="ps-2" alt="Add" /></a></li>
					
					<li><a href="<?php echo base_url(); ?>master/list-supplier">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
                ...
                <div class="col-12 col-sm-12">
                  <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                      <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Supplier</button>
                    </div>
                  </nav>

                  <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab" tabindex="0">
<?php echo form_open('', ['id'=>'supplierForm']); ?>
  <!-- Start -->
  <div class="row mb-4">
	<!-- Column 1 -->
	  <div class="col-12 col-sm-12 col-md-4">
		<div id="response"></div>
		  <div class="row mb-2">
			<div class="col-sm-5">
			  <label class="col-form-label">Supplier Code<sup>*</sup></label>
			</div>
			<div class="col-sm-7">
		  ...
		  <div class="row mb-2">
			<div class="col-sm-5">
			  <label class="col-form-label">Supplier Name<sup>*</sup></label>
			</div>
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="sname" id="sname" maxlength="60" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			<div class="col-sm-5">
			  <label class="col-form-label">Supplier Currency<sup>*</sup></label>
			</div>
			<div class="col-sm-7">
	  ...
	  <div class="col-12 col-sm-12 col-md-4">
		  <div class="row mb-2">
			<div class="col-sm-5">
			  <label class="col-form-label">Delivery Terms<sup>*</sup></label>
			</div>
			<div class="col-sm-7">
			  <select class="form-select js-example-basic-single" name="terms" id="terms">
				<option value="">----</option>
			  <?php if(!empty($dterms)) { 
			  foreach($dterms as $row){
			  ?>
			  <option value="<?php echo $row['codeID']; ?>"><?php echo $row['generalTitle']; ?></option>
			  <?php }
			  } ?>
			  </select>
		  ...
		  <div class="row mb-2">
			<div class="col-sm-5">
			  <label class="col-form-label">Credit Terms<sup>*</sup></label>
			</div>
			<div class="col-sm-7">
			  <select class="form-select js-example-basic-single" name="credit" id="credit">
				<option value="">----</option>
			  <?php if(!empty($cterms)) { 
			  foreach($cterms as $row){
			  ?>
			  <option value="<?php echo $row['codeID']; ?>"><?php echo $row['generalTitle']; ?></option>
			  <?php }
			  } ?>
			  </select>
			  <div class="invalid-feedback" id="error_credit"></div>
			</div>
		  </div>
		<div class="row mb-2">
			<div class="col-sm-5">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="gstno" id="gstno" maxlength="30" autocomplete="off" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" title="Invalid GST Number." />
	...
	<!-- Column 1 -->
	  <div class="col-12 col-sm-12 col-md-4">
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="address1" id="address1" maxlength="150" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="address2" id="address2" maxlength="150" autocomplete="off" />
		   ...
		   <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="address3" id="address3" maxlength="150" autocomplete="off" />
	  ...
	  <div class="col-12 col-sm-12 col-md-4">
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="city" id="city" maxlength="60" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="state" id="state" maxlength="60" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="country" id="country" maxlength="60" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="pin" id="pin" maxlength="30" autocomplete="off" />
	  ...
	  <div class="col-12 col-sm-12 col-md-4">
		<div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="phone1" id="phone1" maxlength="30" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="phone2" id="phone2" maxlength="30" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="email" class="form-control" name="email1" id="email1" maxlength="100" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="email" class="form-control" name="email2" id="email2" maxlength="100" autocomplete="off" />
  ...
  <div class="row">
	...
	<div class="col-12 col-sm-12 col-md-4">
	  <div class="row mb-2">
		...
		<div class="col-sm-7">
		  <input type="text" class="form-control" name="attrb[]" id="attrb<?php echo $k; ?>" autocomplete="off" />
	  ...
	  <table class="table table-bordered">
		  ...
		  <tbody id="tbody">
			<tr>
			  <td>1</td>
			  <td>
				<input type="text" class="form-control form-control1 text-center" name="cname[]" id="cname0" maxlength="60" autocomplete="off" />
				<div class="invalid-feedback" id="error_cname0"></div>
			  </td>
			  <td>
				<input type="text" class="form-control form-control1 text-center" name="position[]" id="position0" maxlength="60" autocomplete="off" />
				<div class="invalid-feedback" id="error_position0"></div>
			</td>
			  <td>
				<input type="email" class="form-control form-control1 text-center" name="cemail[]" id="cemail0" maxlength="100" autocomplete="off" />
				<div class="invalid-feedback" id="error_cemail0"></div>
			</td>
			  <td>
				<input type="number" class="form-control form-control1 text-center" name="cphone[]" id="cphone0" maxlength="30" autocomplete="off" />
				<div class="invalid-feedback" id="error_cphone0"></div>
			</td>
			  <td>
				<input type="number" class="form-control form-control1 text-center" name="ctele[]" id="ctele0" maxlength="30" autocomplete="off" />
...
$('#terms').select2({
	...
	minimumInputLength: 2,
	ajax: {
		url: '<?php echo base_url(); ?>master/select2-generalcode/9',
		//type: 'post',
		dataType: 'json',
		delay: 250,
		data: function (params) {
...
$('#credit').select2({
	...
	minimumInputLength: 2,
	ajax: {
		url: '<?php echo base_url(); ?>master/select2-generalcode/10',
		//type: 'post',
		dataType: 'json',
		delay: 250,
		data: function (params) {
...
$("#supplierForm").submit(function(e){
	...
	form_data.append('supplierform', 'true');
	$.ajax({
		type: "POST",
		...
		success:function(res){
			...
			if(res.status == false) {
				...
				$("#supplierForm .invalid-feedback").each(function(){
					let idstr;
			...
			if(res.status == true) {
				//location.reload();
				setTimeout(function(){
					   window.location.href="<?php echo base_url(); ?>master/list-supplier";
				  }, 1500);
			}
	},
	error:function(){
