			  ...
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1">
				 <ul>
					...
					<li><a href="<?php echo base_url(); ?>master/list-company" class="activelink">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
...
<?php if(!empty($companyList)) { ?>
 <table id="datatable1" class="table table-bordered cell-border item-code-table table-hover" style="width:100%">
  ...
  ?>
	<tr>
	  <td class="ps-1"><?php echo $row['company_name']; ?></td>
	  <td class="ps-1"><?php echo $row['reg_no']; ?></td>
	  <td class="ps-1"><?php echo $row['telephone_1']; ?></td>
	  <td class="ps-1"><?php echo $row['email_1']; ?></td>
	  <td>							
		<?php if(user_right('master/edit-company') == true){ ?>
		<a href="<?php echo base_url(); ?>master/edit-company/<?php echo $row['company_ID']; ?>" class="ms-1 me-2 text-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
	<?php } ?>
	  </td>
	</tr>
  <?php } ?>
