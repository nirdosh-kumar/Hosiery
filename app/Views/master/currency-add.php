          ...
          <div class="row">
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1">				  
				  <ul>
					<li><a href="<?php echo base_url(); ?>master/add-currency" class="activelink">Add <img src="<?php echo base_url(); ?>public/assets/img/icons/add-icon.png" class="ps-2" alt="Add" /></a></li>
					
					<li><a href="<?php echo base_url(); ?>master/list-currency">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
...
<div class="col-12 col-sm-12 col-md-4">
  ...
  <div class="row mb-2">
	...
	<div class="col-sm-7">
	  <input type="text" class="form-control" name="deci" id="deci" autocomplete="off" />
