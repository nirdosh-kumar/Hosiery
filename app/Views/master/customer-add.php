	  ...
	  <div class="col-12 col-sm-12 col-md-4">
		<div id="response"></div>
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="fixed" id="fixed" maxlength="8" autocomplete="off" />
	  ...
	  <div class="col-12 col-sm-12 col-md-4">
		...
		<div class="row mb-2">
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="vatno" id="vatno" maxlength="30" autocomplete="off" />
			  <div class="invalid-feedback" id="error_gstno"></div>
			</div>
		  </div>
	  </div>
