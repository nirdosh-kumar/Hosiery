           ...
           <div class="row">
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1">
				  <ul>
					<li><a href="<?php echo base_url(); ?>master/add-supplier" class="">Add <img src="<?php echo base_url(); ?>public/assets/img/icons/add-icon.png" class="ps-2" alt="Add" /></a></li>
					...
					<li><a href="<?php echo base_url(); ?>master/delete-supplier/<?php echo $editRow['supplier_ID']; ?>" class="delete">Delete <img src="<?php echo base_url(); ?>public/assets/img/icons/delete-icon.png" class="ps-2" alt="Delete" /></a></li>
  ...
  <div class="row mb-4">
	<!-- Column 1 -->
	  <div class="col-12 col-sm-12 col-md-4">
		<div id="response"><?php //echo _p($editRow); ?></div>
		  <div class="row mb-2">
			<div class="col-sm-5">
			  <label class="col-form-label">Supplier Code<sup>*</sup></label>
			</div>
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="code" id="code" maxlength="8" autocomplete="off" value="<?php echo $editRow['supplier_code']; ?>" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="sname" id="sname" maxlength="60" autocomplete="off" value="<?php echo $editRow['supplier_name']; ?>" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  ...
			  ?>
				<option value="<?php echo $row['currency_ID']; ?>" <?php if($editRow['supplier_currency']==$row['currency_ID']) echo 'selected'; ?>><?php echo $row['currency_name']; ?></option>
			  <?php }
			  } ?>
			  </select>
	  ...
	  <div class="col-12 col-sm-12 col-md-4">
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  ...
			  ?>
			  <option value="<?php echo $row['codeID']; ?>" <?php if($editRow['delivery_terms_ID']==$row['codeID']) echo 'selected'; ?>><?php echo $row['generalTitle']; ?></option>
			  <?php }
			  } ?>
			  </select>
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  ...
			  ?>
			  <option value="<?php echo $row['codeID']; ?>" <?php if($editRow['credit_terms_ID']==$row['codeID']) echo 'selected'; ?>><?php echo $row['generalTitle']; ?></option>
			  <?php }
			  } ?>
			  </select>
  ...
  <div class="row">
	...
	<div class="col-12 col-sm-12 col-md-4">
	  <div class="row mb-2">
		...
		<div class="col-sm-7">
		  <input type="text" class="form-control" name="attrb[]" id="attrb<?php echo $k; ?>" value="<?php echo $attr; ?>" />
	  ...
	  <table class="table table-bordered">
		  ...
		  ?>
			<tr id="del-<?php echo $k; ?>">
			  ...
			  <td>
				<input type="text" class="form-control form-control1 text-center" name="position[]" id="position0" maxlength="60" autocomplete="off" value="<?php echo $row['contactPos']; ?>" />
				<div class="invalid-feedback" id="error_position0"></div>
			</td>
			  <td>
				<input type="email" class="form-control form-control1 text-center" name="cemail[]" id="cemail0" maxlength="100" autocomplete="off" value="<?php echo $row['contactEmail']; ?>" />
				<div class="invalid-feedback" id="error_cemail0"></div>
			</td>
			  <td>
				<input type="number" class="form-control form-control1 text-center" name="cphone[]" id="cphone0" maxlength="30" autocomplete="off" value="<?php echo $row['contactPhone']; ?>" />
				<div class="invalid-feedback" id="error_cphone0"></div>
			</td>
			  <td>
				<input type="number" class="form-control form-control1 text-center" name="ctele[]" id="ctele0" maxlength="30" autocomplete="off" value="<?php echo $row['contactTele']; ?>" />
