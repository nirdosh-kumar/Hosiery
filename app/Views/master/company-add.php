           ...
           <div class="row">
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1">
				  <ul>
					<li><a href="<?php echo base_url(); ?>master/add-company" class="activelink">Add <img src="<?php echo base_url(); ?>public/assets/img/icons/add-icon.png" class="ps-2" alt="Add" /></a></li>
					
					<li><a href="<?php echo base_url(); ?>master/list-company">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
	...
	<!-- Column 1 -->
	  <div class="col-12 col-sm-12 col-md-4">
		<div id="response"></div>
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="regno" id="regno" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <select class="form-select js-example-basic-single" name="owner" id="owner">
				<option value="">----</option>
	  ...
	  <div class="col-12 col-sm-12 col-md-4">
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="gstno" id="gstno" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" title="Invalid GST Number." autocomplete="off" />
	...
	<!-- Column 1 -->
	  <div class="col-12 col-sm-12 col-md-4">
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="address1" id="address1" autocomplete="off" />
		  ...
		  <div class="row mb-2">
		   ...
		   <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="address3" id="address3" autocomplete="off" />
	  ...
	  <div class="col-12 col-sm-12 col-md-4">
		<div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="phone1" id="phone1" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="phone2" id="phone2" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="email" class="form-control" name="email1" id="email1" autocomplete="off" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="email" class="form-control" name="email2" id="email2" autocomplete="off" />
