          ...
          <div class="row">
			  <div class="col-12">
				...
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>user/list-group" class="activelink">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
                ...
                <div class="col-12 col-sm-12 mb-1">
                  <nav>
                    <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                      <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Group List</button>
                    </div>
                  </nav>
                </div>  
              </div>
...
<?php if(!empty($groupList)) { ?>
 <table id="datatable1" class="table table-bordered cell-border item-code-table table-hover" style="width:100%">
  ...
  ?>
	<tr>
	  <td class="ps-1"><?php echo $row['groupTitle']; ?></td>
	  <td>							
		<?php if($row['groupTitle'] !== 'Super Admin') { 
			if(user_right('user/edit-group') == true){
		?>
		<a href="<?php echo base_url(); ?>user/edit-group/<?php echo $row['groupID']; ?>" class="ms-1 me-2 text-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
	<?php } if(user_right('user/right-group') == true){ ?>
		<a href="<?php echo base_url(); ?>user/right-group/<?php echo $row['groupID']; ?>" class="me-2 text-success"><i class="fa fa-key" aria-hidden="true"></i></a>
	<?php } 
		} ?>
	  </td>
	</tr>
