          ...
          <div class="row">
			  <div class="col-12">
				...
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>user/list-group" class="">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
					...
					<li><a href="<?php echo base_url(); ?>user/delete-group/<?php echo $editRow['groupID']; ?>" class="delete">Delete <img src="<?php echo base_url(); ?>public/assets/img/icons/delete-icon.png" class="ps-2" alt="Delete" /></a></li>
  ...
  <div class="col-12 col-sm-12 col-md-4">
	<div id="response"></div>
	  <div class="row mb-2">
		...
		<div class="col-sm-7">
		  <input type="text" class="form-control" name="title" id="title" value="<?php echo $editRow['groupTitle']; ?>" autocomplete="off" />
