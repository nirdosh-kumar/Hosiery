          ...
          <div class="row">
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1">
				  <ul>
					<li><a href="<?php echo base_url(); ?>general-code/add-general-code" class="activelink">Add <img src="<?php echo base_url(); ?>public/assets/img/icons/add-icon.png" class="ps-2" alt="Add" /></a></li>
					<li><a href="<?php echo base_url(); ?>general-code/list-general-code">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
...
<div class="col-12 col-sm-12 col-md-4">
  <div class="row mb-2">
	...
	<div class="col-sm-7">
	  ...
	  ?>
		<option value="<?php echo $row['typeID']; ?>"><?php echo $row['typeTitle']; ?></option>
	  <?php }
	  } ?>
	  </select>
  ...
  <div class="row mb-2">
	...
	<div class="col-sm-7">
	  <input type="text" class="form-control" name="msg" id="msg" autocomplete="off" />
...
<div class="col-12 col-sm-12 col-md-4">
  <div class="row mb-2">
	...
	<div class="col-sm-7">
	  <input type="number" class="form-control" name="order1" id="order1" value="9999" autocomplete="off" />
  ...
  <div class="row mb-2">
	...
	<div class="col-sm-7">
	  <input type="number" class="form-control" name="order2" id="order2" value="9999" autocomplete="off" />
