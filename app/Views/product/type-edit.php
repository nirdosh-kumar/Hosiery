			  ...
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1">
				  <ul>
						...
						<li><a href="<?php echo base_url(); ?>product/list-type" class="">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
						...
						<li><a href="<?php echo base_url(); ?>product/delete-type/<?php echo $editRow['product_type_ID']; ?>" class="delete">Delete <img src="<?php echo base_url(); ?>public/assets/img/icons/delete-icon.png" class="ps-2" alt="Delete" /></a></li>
	  ...
	  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <select class="form-select js-example-basic-single" name="typecat" id="typecat">
				...
				?>
				<option value="<?php echo $row['product_category_ID']; ?>" <?php if($editRow['product_category_ID'] == $row['product_category_ID']) echo 'selected'; ?>><?php echo $row['product_category_name']; ?></option>
				<?php }
				} ?>
			  </select>
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="code" id="code" maxlength="8" autocomplete="off" value="<?php echo $editRow['product_type_code']; ?>" />
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="typename" id="typename" maxlength="60" autocomplete="off" value="<?php echo $editRow['product_type_name']; ?>" />
