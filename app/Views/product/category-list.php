			  ...
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1"> 
				 <ul>
					...
					<li><a href="<?php echo base_url(); ?>product/list-category" class="activelink">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
                ...
                <div class="col-12 col-sm-12 mb-1">
                  <nav>
                    <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                      <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Product Category List</button>
                    </div>
                  </nav>
                </div>  
              </div>
...
<?php if(!empty($categoryList)) { ?>
 <table id="datatable1" class="table table-bordered cell-border item-code-table table-hover" style="width:100%">
  ...
  ?>
	<tr>
	  <td class="ps-1"><?php echo $row['product_category_code']; ?></td>
	  <td class="ps-1"><?php echo $row['product_category_name']; ?></td>
	  <td class="ps-1"><?php echo $row['userName']; ?></td>
	  <td>							
		<?php if(user_right('product/edit-category') == true){ ?>
		<a href="<?php echo base_url(); ?>product/edit-category/<?php echo $row['product_category_ID']; ?>" class="ms-1 me-2 text-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
	<?php } ?>
	  </td>
	</tr>
  <?php } ?>
