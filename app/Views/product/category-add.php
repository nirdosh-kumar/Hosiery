           ...
           <div class="row">
			  <div class="col-12">
				<div id="sidebaricons" class="sidenav1">
				  <ul>
					<li><a href="<?php echo base_url(); ?>product/add-category" class="activelink">Add <img src="<?php echo base_url(); ?>public/assets/img/icons/add-icon.png" class="ps-2" alt="Add" /></a></li>
					<li><a href="<?php echo base_url(); ?>product/list-category">View <img src="<?php echo base_url(); ?>public/assets/img/icons/viewall-icon.png" class="ps-2" alt="edit" /></a></li>
	...
	<!-- Column 1 -->
	  ...
	  <div id="response"></div>
		  ...
		  <div class="row mb-2">
			...
			<div class="col-sm-7">
			  <input type="text" class="form-control" name="catname" id="catname" maxlength="60" autocomplete="off" />
